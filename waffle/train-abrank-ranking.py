...
from waffle.models.abrank_ranking_gcn import RegressionGCNAbAgIntLM
...
def log_config_to_wandb(config: DictConfig, wandb_run: wandb.sdk.wandb_run.Run) -> None:
    ...
    wandb_run.config.update(config_dict)
...
def main(cfg: DictConfig) -> None:
    ...
    logger.info(f"Random seed was not set for datamodule, use random seed: {cfg.dataset.datamodule.seed}")
